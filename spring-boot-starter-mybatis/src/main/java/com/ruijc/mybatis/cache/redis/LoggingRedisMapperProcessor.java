...
/**
 * LoggingRedisMapper处理器
 *
 * @author Storezhang
 */
@AutoService(Processor.class)
public class LoggingRedisMapperProcessor extends BaseProcessor {

    @Override
    public Set<String> getSupportedAnnotationTypes() {
        return Collections.singleton(LoggingRedisMapper.class.getCanonicalName());
    }
    ...
    protected RedisMapperProperties getMapperProperties(TypeElement clazzElement) {
        ...
        LoggingRedisMapper redisMapperAnnotation = clazzElement.getAnnotation(LoggingRedisMapper.class);
        try {
    ...
    protected Set<Element> getElement(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        return (Set<Element>) roundEnv.getElementsAnnotatedWith(LoggingRedisMapper.class);
    }
}

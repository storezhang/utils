...
package com.ruijc.sevenzip.compression.lzma;

import com.ruijc.sevenzip.compression.rangecoder.BitTreeEncoder;
...
public class Encoder {
    ...
    class LiteralEncoder {
        class Encoder2 {
            ...
            public void init() {
                com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(m_Encoders);
            }


            public void encode(com.ruijc.sevenzip.compression.rangecoder.Encoder rangeEncoder, byte symbol) throws IOException {
                int context = 1;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public void encodeMatched(com.ruijc.sevenzip.compression.rangecoder.Encoder rangeEncoder, byte matchByte, byte symbol) throws IOException {
                int context = 1;
                boolean same = true;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public int getPrice(boolean matchMode, byte matchByte, byte symbol) {
                ...
                if (matchMode) {
                    for (; i >= 0; i--) {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice(m_Encoders[((1 + matchBit) << 8) + context], bit);
                        context = (context << 1) | bit;
                        if (matchBit != bit) {
                            i--;
                            break;
                ...
                for (; i >= 0; i--) {
                    int bit = (symbol >> i) & 1;
                    price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice(m_Encoders[context], bit);
                    context = (context << 1) | bit;
                }
                return price;
            }
    ...
    class LenEncoder {
        ...
        public void init(int numPosStates) {
            com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_choice);
        ...
        public void encode(com.ruijc.sevenzip.compression.rangecoder.Encoder rangeEncoder, int symbol, int posState) throws IOException {
        ...
        public void setPrices(int posState, int numSymbols, int[] prices, int st) {
            int a0 = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_choice[0]);
            int a1 = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_choice[0]);
            int b0 = a1 + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_choice[1]);
            int b1 = a1 + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_choice[1]);
            int i;
    ...
    private com.ruijc.sevenzip.compression.lz.BinTree _matchFinder = null;
    private final com.ruijc.sevenzip.compression.rangecoder.Encoder _rangeEncoder = new com.ruijc.sevenzip.compression.rangecoder.Encoder();
    ...
    void create() {
        if (_matchFinder == null) {
            com.ruijc.sevenzip.compression.lz.BinTree bt = new com.ruijc.sevenzip.compression.lz.BinTree();
            int numHashBytes = 4;
    ...
    void init() {
        ...
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isMatch);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRep0Long);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRep);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG0);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG1);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_isRepG2);
        com.ruijc.sevenzip.compression.rangecoder.Encoder.initBitModels(_posEncoders);
    ...
    int getRepLen1Price(int state, int posState) {
        return com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRepG0[state]) +
                com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
    }

    int getPureRepPrice(int repIndex, int state, int posState) {
        int price;
        if (repIndex == 0) {
            price = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRepG0[state]);
            price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
        } else {
            price = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRepG0[state]);
            if (repIndex == 1) {
                price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRepG1[state]);
            } else {
                price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRepG1[state]);
                price += com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice(_isRepG2[state], repIndex - 2);
            }
        }
        return price;
    }
    ...
    int getOptimum(int position) throws IOException {
        ...
        _optimum[1].Price = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
                _literalEncoder.getSubCoder(position, _previousByte).getPrice(!Base.stateIsCharState(state), matchByte, currentByte);
        _optimum[1].makeAsChar();

        int matchPrice = com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
        int repMatchPrice = matchPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRep[state]);
        ...
        int normalMatchPrice = matchPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRep[state]);
        ...
        while (true) {
            ...
            int curAnd1Price = curPrice +
                    com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
            ...
            matchPrice = curPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
            repMatchPrice = matchPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRep[state]);
            ...
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    int nextRepMatchPrice = curAnd1Price +
                            com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                            com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRep[state2]);
                    {
                    ...
                    if (lenTest2 >= 2) {
                        ...
                        int curAndLenCharPrice =
                                repMatchPrice + getRepPrice(repIndex, lenTest, state, posState) +
                                        com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                        ...
                        int nextMatchPrice = curAndLenCharPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
                        int nextRepMatchPrice = nextMatchPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice1(_isRep[state2]);
            ...
            if (newLen >= startLen) {
                normalMatchPrice = matchPrice + com.ruijc.sevenzip.compression.rangecoder.Encoder.getPrice0(_isRep[state]);
    ...
    void fillDistancesPrices() {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
            ...
            for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++) {
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << com.ruijc.sevenzip.compression.rangecoder.Encoder.kNumBitPriceShiftBits);
            }

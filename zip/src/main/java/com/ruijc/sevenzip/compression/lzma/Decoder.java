...
import com.ruijc.sevenzip.compression.lz.OutWindow;
import com.ruijc.sevenzip.compression.rangecoder.BitTreeDecoder;
...
class Decoder {
    class LenDecoder {
        ...
        public void init() {
            com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_Choice);
        ...
        public int decode(com.ruijc.sevenzip.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void init() {
                com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_Decoders);
            }

            public byte decodeNormal(com.ruijc.sevenzip.compression.rangecoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do {
            ...
            public byte decodeWithMatchByte(com.ruijc.sevenzip.compression.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do {
    ...
    private final com.ruijc.sevenzip.compression.rangecoder.Decoder m_RangeDecoder = new com.ruijc.sevenzip.compression.rangecoder.Decoder();
    ...
    void init() throws IOException {
        ...
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsMatchDecoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRep0LongDecoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepDecoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG0Decoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG1Decoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_IsRepG2Decoders);
        com.ruijc.sevenzip.compression.rangecoder.Decoder.initBitModels(m_PosDecoders);
